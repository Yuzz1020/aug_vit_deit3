...
def get_args_parser():
    ...
    # AugViT
    parser.add_argument('--patch_aug', type=str, default='jit_cut_blur_solar_gray', help='activated patch augment, if not, use vanilla, need manually set') # part implemented, may modify
    parser.add_argument('--mapping', type=str, default='inv_linear', help='mapping function from attn score to import score') # implemented
...
def main(args):
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        train_stats = train_one_epoch(
            ...
            args = args, proxy_model=proxy_model,
        )
